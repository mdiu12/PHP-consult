...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="faq-category-add.php" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
            	...
            	foreach ($result as $row) {
	                ...
	                <tr>
	                    ...
	                    <td>
	                        ...
	                        <a href="#" class="btn btn-danger btn-xs" data-href="faq-category-delete.php?id=<?php echo $row['faq_category_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
	                    </td>
	                </tr>
	                <?php
            	}
